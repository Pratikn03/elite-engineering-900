...
- **LeetCode Link**: [https://leetcode.com/problems/additive-number/](https://leetcode.com/problems/additive-number/)
- **Backup Search**: [Google Search](https://www.google.com/search?q=LeetCode+Additive+Number)
...
### Quick Overview
Additive Number - Solve this problem using techniques from **Backtracking**.
...
- [ ] Core pattern recognition for backtracking problems
...
### Phase 2: Plan
- [ ] Identify the pattern (from Backtracking)
...
## 🎓 Key Concepts for Backtracking

Make sure you're comfortable with these concepts:
- Pattern recognition specific to backtracking
- Common algorithms used in backtracking
...
- Same category: `backtracking/`
- Other backtracking variations
- Problems that combine backtracking with other patterns
...
- [LeetCode Discussion](https://leetcode.com/problems/additive-number/discuss/)
- [Solution Patterns for Backtracking](../README.md)
- [Google Search for Hints](https://www.google.com/search?q=LeetCode+Additive+Number)
